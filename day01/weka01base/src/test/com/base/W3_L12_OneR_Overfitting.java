...
public class W3_L12_OneR_Overfitting {
	...
	public void weatherNumericHoldOutOneR(boolean isRemove, int minBucketSize) throws Exception{
		int seed = 1;
		// 1) data loader 
		Instances data=new Instances(new BufferedReader(new FileReader("C:\\MULTI_EDU\\wekaWork\\weka-main\\data\\weather.numeric.arff")));
		if(isRemove){
	...
	public void diabeteCrossValidationOneR(Classifier obj, boolean isUseTrainingSet, int minBucketSize) throws Exception{
		...
		// 1) data loader 
		Instances data=new Instances(new BufferedReader(new FileReader("C:\\MULTI_EDU\\wekaWork\\weka-main\\data\\diabetes.arff")));
